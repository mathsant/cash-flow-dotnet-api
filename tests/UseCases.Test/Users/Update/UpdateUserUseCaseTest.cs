...
public class UpdateUserUseCaseTest
{
    ...
    public async Task Error_Name_Empty()
    {
        ...
        result.Where(ex => ex.GetErrors().Count == 1 && ex.GetErrors().Contains("USER_NAME_EMPTY"));
    }
    ...
    public async Task Error_Email_Already_Exist()
    {
        ...
        result.Where(ex => ex.GetErrors().Count == 1 && ex.GetErrors().Contains("EMAIL_ALREADY_REGISTED"));
    }
